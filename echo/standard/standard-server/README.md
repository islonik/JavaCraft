...
`standard-server` is the blocking socket server module for the Standard Echo example.  
...
- `my.javacraft.echo.standard.server.common.MultithreadedServer`
...
- `my.javacraft.echo.standard.server.common.ServerThread`
...
- `my.javacraft.echo.standard.server.platform.PlatformServer`
  - Starts each `ServerThread` on a platform daemon thread.
- `my.javacraft.echo.standard.server.virtual.VirtualServer`
  - Starts each `ServerThread` on a virtual thread.
- `my.javacraft.echo.standard.server.common.PortValidator`
...
```bash
mvn -pl echo/standard/standard-server test
```
...
- `my.javacraft.echo.standard.server.platform.PlatformServerApplication`
- `my.javacraft.echo.standard.server.virtual.VirtualServerApplication`
