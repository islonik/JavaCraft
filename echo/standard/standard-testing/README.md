...
`standard-testing` contains Cucumber end-to-end tests for the Standard Echo system.  
...
- `src/test/resources/features/standard.feature` (functional + edge cases + high load)
- `src/test/resources/features/benchmark.feature` (performance-only scenarios)
...
- `StandardStepDefinitions` - functional and load steps.
- `BenchmarkStepDefinitions` - benchmark/performance steps.
...
Runner: `my.javacraft.echo.standard.CucumberRunner`
...
```bash
mvn -pl echo/standard/standard-testing -am test
```

Run only functional virtual scenarios:

```bash
mvn -pl echo/standard/standard-testing -am test -Dcucumber.filter.tags='@Virtual and not @Performance and not @PerformanceSummary'
```

Run only functional platform scenarios:

```bash
mvn -pl echo/standard/standard-testing -am test -Dcucumber.filter.tags='@Platform and not @Performance and not @PerformanceSummary'
```
