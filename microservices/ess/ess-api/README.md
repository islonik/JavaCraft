...
Shared contract library for the ess module. Contains all request/response models,
enums, validation annotations, and constants consumed by both `ess-app` and `ess-testing`.
